...
function getInstrument(code, from, to, cb) {
    doJsonRequest('GET', 'http://www.btrader.com.ar/v1/instrument/getAllDataWithHistoricalByCode/' + code + '/' + dateToString(from) + '/' + dateToString(to), cb);    
}
